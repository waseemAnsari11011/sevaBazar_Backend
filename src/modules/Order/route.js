...
router.put('/admin-update-payment-status/:orderId', orderController.adminUpdatePaymentStatus);
...
router.get('/order/customer/single/:orderId', orderController.getOrderById);
